...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngAfterViewInit = function () {
        ...
        console.log("Salut");
        this.http.get('assets/auth_request.json')
            .map(function (responseData) {
            _this.makeTheseRequests(responseData.json());
        }).subscribe(function (data) { return function (data) {
        }; }, function (err) { return _this.logError(err); });
    };
    AppComponent.prototype.makeTheseRequests = function (requests) {
        var _this = this;
        console.log(requests);
        for (var _i = 0, requests_1 = requests; _i < requests_1.length; _i++) {
            var req = requests_1[_i];
            if (req.method === "GET") {
                this.http.get(req.url).subscribe(function (data) { return function (data) {
                    console.log("Get authentification response:", data);
                }; }, function (err) { return _this.logError(err); });
            }
        }
    };
