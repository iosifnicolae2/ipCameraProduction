...
var EmployeeStatsComponent = (function () {
    ...
    EmployeeStatsComponent.prototype.ngOnInit = function () {
        var t = this;
        t.update_data();
        this.update_stats = setInterval(function () {
            t.update_data();
        }, 60 * 1000); //60 seconds
    };
    EmployeeStatsComponent.prototype.update_data = function () {
        var t = this;
        t.http.get("http://localhost:6147/api/get_employees_stats/" + t.view_id)
            .map(function (res) {
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* Input */])(), 
        __metadata('design:type', Object)
    ], EmployeeStatsComponent.prototype, "view_id", void 0);
...
module.exports = "\n<div class=\"employees-stats\">\n  <h2>Weekly Summary By Day</h2>\n  <h4>Week Commencing <span id=\"start_at\">12 Mar 2017</span></h4>\n  <h4>All Employees Ordered by Last Name</h4>\n\n  <table style=\"width:100%\" class=\"employee-row-container\">\n  <tr class=\"header\">\n    <th>Location</th>\n    <th>Name</th>\n    <th>Number</th> \n    <th>Mon</th>\n    <th>Tue</th>\n    <th>Wed</th>\n    <th>Thu</th>\n    <th>Fri</th>\n    <th>Sat</th>\n    <th>Sun</th>\n    <th>Total</th>\n  </tr>\n\n  <tr class=\"row employee-row\" *ngFor=\"let employee of stats.employees\">\n    <td>{{employee.Name+' - '+employee.Department}}</td>\n    <td>{{employee.FullName}}</td>\n    <td>{{employee.SerialNo}}</td>\n    <td>{{employee.Monday | date:'MM/dd @ h:mma'}}</td>\n    <td>{{employee.Tuesday | date:'MM/dd @ h:mma'}}</td>\n    <td>{{employee.Wednesday | date:'MM/dd @ h:mma'}}</td>\n    <td>{{employee.Thursday | date:'MM/dd @ h:mma'}}</td>\n    <td>{{employee.Friday | date:'MM/dd @ h:mma'}}</td>\n    <td>{{employee.Saturday | date:'MM/dd @ h:mma'}}</td>\n    <td>{{employee.Sunday | date:'MM/dd @ h:mma'}}</td>\n    <td></td>\n  </tr>\n</table>\n\n</div>\n\n"
